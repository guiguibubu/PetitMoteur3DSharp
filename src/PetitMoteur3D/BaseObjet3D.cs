...
internal abstract class BaseObjet3D : IObjet3D, IDisposable
{
    ...
    /// <inheritdoc/>
    public RenderPassType[] SupportedRenderPasses => [RenderPassType.ForwardOpac, RenderPassType.DeferredShadingGeometry, RenderPassType.DeferredShadingLightning, RenderPassType.DepthTest, RenderPassType.Shadow];
    #endregion
