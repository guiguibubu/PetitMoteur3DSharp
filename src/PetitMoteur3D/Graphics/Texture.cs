...
internal sealed class Texture : IDisposable
{
    ...
    public ComPtr<ID3D11ShaderResourceView> TextureView { get { return _textureView; } init { _textureView = value; } }
    private readonly ComPtr<ID3D11ShaderResourceView> _textureView;
    public ComPtr<ID3D11DepthStencilView> TextureDepthStencilView { get { return _textureDepthStencilView; } init { _textureDepthStencilView = value; } }
    private readonly ComPtr<ID3D11DepthStencilView> _textureDepthStencilView;
