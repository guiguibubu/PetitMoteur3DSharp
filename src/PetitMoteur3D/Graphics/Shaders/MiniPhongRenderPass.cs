...
internal sealed class MiniPhongRenderPass : BaseRenderPass, IDisposable
{
    ...
    public MiniPhongRenderPass(D3D11GraphicPipeline graphicPipeline, string name = "")
